 ...
 */
class ArtistScheduleMapper() {

    fun transformArtists(artists: List<Artist>): List<ArtistSchedule> {
        return artists.map({
            ...
            ArtistSchedule(it.id, it.name, start_time, end_time, it.scenario, dayString)
        })
    }
}